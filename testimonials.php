        ...
        <div id="myTeasers" class="row col-lg-12 justify-content-center">
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    Depuis nous avons fait 4 autres séances (famille pour les 1 an de ma première fille, grossesse/naissance de ma seconde fille et une séance en famille 
                    pour les 4 ans et 1 an des filles) et pour chacune des séances les photos sont superbes. Anne-Laure est très douce et patiente et a un véritable talent 
                    pour capturer les moments précieux de vie. Un immense merci Anne-Laure, pour tous les beaux souvenirs que nous avons grâce à vous, et j'en suis certaine, 
                    pour ceux à venir !"
                    </p>
                </div>
            </div>
